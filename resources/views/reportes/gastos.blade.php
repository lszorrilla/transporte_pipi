...
@section('content')
  <div class="content-heading">
    ...
    <!-- END Language list-->
    Reportes
    <small data-localize="">reporte de gastos</small>
  </div>
  <div class="col-md-12">
    <!-- START panel-->
    <div class="panel  ">
      <div class="panel-body">
        ...
        <form action="#"  id="rep_gastos_form" data-parsley-validate="" novalidate="">
            ...
            <div class="form-group col-md-2">
                <label for="input-date_to" class="">Tipo de gasto</label>
                <select class="form-control select2 input-sm" name="concepto_id" id="" required>
                <option selected="" value="all">Todos</option>
                    @foreach ($conceptos_gastos as $concepto)
      ...
      <div class="panel-body">
        <div id="" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
          <div class="table-responsive">
            <table id="rep_gastos_table" class="datatable table  table-hover">
              <thead>
                <tr>
                  <th>Descripcion</th>
                  <th>Camion No. Placa</th>                  
                  <th>Gasto(concepto)</th>
                  <th>Creado</th>
                  <th>Monto</th>
                </tr>
              </thead>
              <tbody id="rep_gastos_tbody">
  ...
  <script type="text/javascript">
	$(document).ready(function() {
	    $("#search").on('click',function(element) {
	    	...
	    	form = $('#rep_gastos_form').serialize();
	    	form_valid = $('#rep_gastos_form').parsley();
	    	if (form_valid.isValid()) {
	    		element.preventDefault();
	    		$.ajax({
	                data: form,
	                url:  '{{route('reportes.getgastos')}}',
	                method:  'POST',
	                beforeSend: function () {
